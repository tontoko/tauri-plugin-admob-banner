...
pub fn init<R: Runtime, C: DeserializeOwned>(
    _app: &AppHandle<R>,
    api: PluginApi<R, C>,
) -> crate::error::Result<AdmobBanner<R>> {
    #[cfg(target_os = "android")]
    {
...
impl<R: Runtime> AdmobBanner<R> {
    pub fn initialize(&self) -> crate::error::Result<bool> {
    ...
    pub fn show_banner(&self, ad_unit_id: String) -> crate::error::Result<()> {
        let args = ShowBannerArgs { ad_unit_id };
        self.0.run_mobile_plugin("show_banner", args)?;
        Ok(())
    }

    pub fn hide_banner(&self) -> crate::error::Result<()> {
        self.0.run_mobile_plugin("hide_banner", ())?;
        Ok(())
    }

    pub fn can_request_ads(&self) -> crate::error::Result<bool> {
    ...
    pub fn privacy_options_required(&self) -> crate::error::Result<bool> {
    ...
    pub fn show_privacy_options(&self) -> crate::error::Result<()> {
